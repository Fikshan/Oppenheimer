...
public class CreateHeroWithVoucherPojo {
	...
	private ArrayList<VoucherPojo> vouchers;
	
	public ArrayList<VoucherPojo> getVouchers() {
		return vouchers;
	}

	public void setVouchers(ArrayList<VoucherPojo> vouchers) {
